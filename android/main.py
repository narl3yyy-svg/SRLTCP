...
# Make srltcp importable
parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
if parent_dir not in sys.path:
    sys.path.insert(0, parent_dir)

# Import test with safe fallback
try:
    import srltcp
    from srltcp.transports.tcp import TCPTransport
    print("✓ srltcp imported successfully")
except ImportError as e:
    print(f"⚠ srltcp import failed: {e}")
    # Temporary dummy so the app doesn't crash during development
    class TCPTransport:
        pass
